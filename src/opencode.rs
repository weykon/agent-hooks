//! OpenCode adapter.
//!
//! Registers hooks in `~/.config/opencode/hooks.json`.
...
const HOOKS_REL: &str = ".config/opencode/hooks.json";
...
impl ToolAdapter for OpenCodeAdapter {
    ...
    fn is_installed(&self) -> bool {
        detection::home_dir_exists(".config/opencode") || detection::command_exists("opencode")
    }
